...
class ModelPusher:
    ...
    def initiate_model_pusher(self)-> artifact_entity.ModelPusherArtifact:
        try:
            ...
            reset_cols_transformer = load_object(file_path=self.data_transformation_artifact.reset_cols_transformer_object_path)
            ...
            save_object(file_path=self.model_pusher_config.reset_cols_pusher_transformer_object_path, obj=reset_cols_transformer)
            ...
            reset_cols_path = self.model_resolver.get_latest_save_transformer_path(config_entity.reset_cols_TRANSFORMER_OBJECT_FILE_NAME)
            ...
            save_object(file_path=reset_cols_path, obj=reset_cols_transformer)        
